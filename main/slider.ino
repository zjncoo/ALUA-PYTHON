...
const int SLIDER0_PIN = A3; // Persona 0
const int SLIDER1_PIN = A5; // Persona 1

int sliderValue[2] = {0, 0};

// Smoothing leggero per evitare jitter (0.0 = niente smoothing, 1.0 = lentissimo)
...
void loopSlider() {
  ...
  // Smoothing (EMA - exponential moving average)
  sliderValue[0] = (int)(SLIDER_ALPHA * raw0 + (1.0 - SLIDER_ALPHA) * sliderValue[0]);
  sliderValue[1] = (int)(SLIDER_ALPHA * raw1 + (1.0 - SLIDER_ALPHA) * sliderValue[1]);
}
